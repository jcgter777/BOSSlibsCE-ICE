...
To use the libraries, simply 'include' them in the header of your program with this line of code: "AsmComp(BOSSLIBM", which automatically sets up the full-screen mode, closes all open files, and displays a 'splash-screen'.
